...
UFastInputSubsystem* UFastInputSubsystem::self = nullptr;

void UFastInputSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
...
void UFastInputSubsystem::Deinitialize()
{
	// Your subsystem deinitialization logic here
	Super::Deinitialize();
}

UFastInputSubsystem* UFastInputSubsystem::Get()
{
	return self;
}

void UFastInputSubsystem::GetSDetailSingleItemRow(FSlateApplication& SlateApp, TSharedPtr<SDetailSingleItemRow>& OutDetailSingleItemRow)
{
	...
	EditingEditableTextSharedPtr = StaticCastSharedPtr<SEditableText>(WidgetSharedPtr);
...
void UFastInputSubsystem::GetAllPropertiesNameAndClass(TSharedPtr<SDetailSingleItemRow>& InDetailSingleItemRowPtr)
{
	...
	if (PropertyHandlePtrArray.Num()) {
		...
		OnFastInputDetect.Broadcast(PropertyName, Property->GetOwnerClass(), Property->GetOwnerStruct());
	}
}

UClass* UFastInputSubsystem::GetSelectedActorClass()
{
...
void UFastInputSubsystem::SetEditableText(FString InputString)
{
	EditingEditableTextSharedPtr->SetText(FText::FromString(InputString));
}

TArray<FString> UFastInputSubsystem::GetAllPropertyNames(UClass* InClass)
{
...
FString UFastInputSubsystem::FIGetJsonPath(FString PropertyName, UClass* Class, UStruct* Struct)
{
...
TArray<FString> UFastInputSubsystem::GetAllSelections(FString PropertyName, UClass* Class, UStruct* Struct, UClass* ObjectClass)
{
...
TSharedPtr<FJsonObject> UFastInputSubsystem::FIReadJson(const FString& FilePath)
{
	FString Content;
...
TSharedPtr<FJsonObject> UFastInputSubsystem::FIMakeJson(UDataTable* DT)
{
...
bool UFastInputSubsystem::FISaveJson(FString PropertyName, UClass* Class, UStruct* Struct, UClass* ObjectClass, UDataTable* DT)
{
